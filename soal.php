    ...
    <div id="main" class="alt">
        ...
        <div class="col-12 d-flex justify-content-center text-center">
            <form action="cek.php" method="POST">
                ...
                <label><h5>Hallo <?php echo $_SESSION["name"];?>, tetap semangat ya...you can do the best!!!</h5><label>
                ...
                <div class="form-group">
                <input class="form-control"  name="hasil" placeholder="Masukkan Jawaban" type="number" required>
                </div>
                <div class="w3-container w3-center w3-animate-left">
                <button type="submit" value="jawab" class="btn btn-primary">Jawab</button>
                </div>
            </form>
        </div>
        </div>
